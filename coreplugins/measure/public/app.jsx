...
export default class App {
  constructor(map, openPopup, onTogglepopup) {
    ...
    document.querySelector(".leaflet-control-measure-toggle").addEventListener("click", () => {
      this.onTogglePopup("measure");
    })
  }

  update(openPopup) {

    if(openPopup !== "measure") {
      document.querySelector(".leaflet-control-measure-close-button.close-button")?.click();
    }
  }
}